...
To run the model we loaded the default MadingleyR inputs. We selected the North America region (Canada, United States and Mexico) and crop and masked all the spatial inputs to reduce the size of the files for better handling. We ran the model for an *spin-up* of **200 years** and a *max cohort size* of **100**.
